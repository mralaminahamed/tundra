...
| Exploring unfamiliar codebase areas              | `/explore-codebase`                           |
| Risk-scored review of changed code               | `/review-changes`                             |
| Debugging with graph-powered call tracing        | `/debug-issue`                                |
| Planning or executing a rename/move/delete       | `/refactor-safely`                            |
...
Faster, cheaper, gives structural context (callers, dependents, test coverage) that file scanning cannot.
